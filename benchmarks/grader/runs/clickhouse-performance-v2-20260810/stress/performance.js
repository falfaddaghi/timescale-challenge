...
const SEED = 6122026;
const SCENARIO_MARKER = "clickhouse-performance-v2-20260810-stress";
...
export const options = {"scenarios":{"stress":{"executor":"ramping-arrival-rate","startRate":150,"timeUnit":"1s","preAllocatedVUs":150,"stages":[{"target":150,"duration":"30s"},{"target":225,"duration":"60s"},{"target":300,"duration":"60s"}]}},"thresholds":{"http_req_failed":["rate<0.05"],"http_req_duration":["p(95)<1000"]}};
export function handleSummary(data) { return { "/repo/benchmarks/grader/runs/clickhouse-performance-v2-20260810/stress/summary.json": JSON.stringify({ tester: "performance-v4", metrics: data.metrics }) }; }
