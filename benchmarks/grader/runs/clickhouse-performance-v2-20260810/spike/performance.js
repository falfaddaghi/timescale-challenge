...
const SEED = 6122026;
const SCENARIO_MARKER = "clickhouse-performance-v2-20260810-spike";
...
export const options = {"scenarios":{"spike":{"executor":"ramping-arrival-rate","startRate":75,"timeUnit":"1s","preAllocatedVUs":75,"stages":[{"target":75,"duration":"30s"},{"target":300,"duration":"10s"},{"target":75,"duration":"60s"}]}},"thresholds":{"http_req_failed":["rate<0.1"],"http_req_duration":["p(95)<2000"]}};
export function handleSummary(data) { return { "/repo/benchmarks/grader/runs/clickhouse-performance-v2-20260810/spike/summary.json": JSON.stringify({ tester: "performance-v4", metrics: data.metrics }) }; }
