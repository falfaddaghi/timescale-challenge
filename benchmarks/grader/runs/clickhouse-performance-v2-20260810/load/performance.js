...
const SEED = 6122026;
const SCENARIO_MARKER = "clickhouse-performance-v2-20260810-load";
...
export const options = {"scenarios":{"load":{"executor":"ramping-arrival-rate","startRate":150,"timeUnit":"1s","preAllocatedVUs":150,"stages":[{"target":150,"duration":"120s"}]}},"thresholds":{"http_req_failed":["rate<0.01"],"http_req_duration":["p(95)<500"]}};
export function handleSummary(data) { return { "/repo/benchmarks/grader/runs/clickhouse-performance-v2-20260810/load/summary.json": JSON.stringify({ tester: "performance-v4", metrics: data.metrics }) }; }
